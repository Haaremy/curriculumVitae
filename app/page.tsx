    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-8 pt-20 bg-pink-50 dark:bg-gray-900">
      ...
      <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl text-center mb-12">
        ...
        <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line">
          Fühl dich frei, alle Seiten zu erkunden. Diese Website dient meinen persönlichen Experimenten und für sonstige temporäre Zwecke. Es kann passieren, dass die Website nicht erreichbar ist, da der entsprechende Server zwar dauerhaft läuft, aber keinen kommerziellen Zweck erfüllt.
        </p> 
      </section>
      {/* Willkommen Section */}
      <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl text-center mb-12">
