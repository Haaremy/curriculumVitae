...
export default function Navigation({ directories = [] }: { directories?: DirectoryInfo[] }) {
    ...
    const filteredDirectories = useMemo(() => {
        return directories
            ...
            .filter((dir) => dir.path.includes("\\de"));
    ...
    useEffect(() => {
        ...
        setDynamicHref(currentPath.startsWith("/de/Weihnachtsolympiade") ? "/de/Weihnachtsolympiade" : "/de");
    }, []);
    ...
    return (
        <main className="bg-gray-100 dark:bg-gray-900 z-50">
            ...
            >
                ...
                >
                    {filteredDirectories.length === 0 ? (
                        <p className="text-center text-gray-500 dark:text-gray-400">Keine Einträge.</p>
                    ) : (
